...
export default function HomePage() {
  const handleContinue = () => {
    window.location.href = 'https://www.freefiremania.com.br/noticia/conjunto-guerreiro-misterioso-token-royale.html'
  }
        ...
        <footer className="mt-8 text-center">
          <div className="bg-white rounded-lg shadow-sm p-6 border border-slate-200">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-xs">
              <a href="/termos" className="text-blue-600 hover:text-blue-700 hover:underline">
                Termos de Uso
              </a>
              <span className="text-slate-300">•</span>
              <a href="/privacidade" className="text-blue-600 hover:text-blue-700 hover:underline">
                Política de Privacidade
              </a>
              <span className="text-slate-300">•</span>
              <a href="/politica-de-reembolso" className="text-blue-600 hover:text-blue-700 hover:underline">
                Política de Reembolso
              </a>
              <span className="text-slate-300">•</span>
              <a href="/quem-somos" className="text-blue-600 hover:text-blue-700 hover:underline">
                Quem Somos
              </a>
            </div>
